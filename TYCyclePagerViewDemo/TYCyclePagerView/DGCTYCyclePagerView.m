...
@interface DGCTYCyclePagerView () <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, TYCyclePagerTransformLayoutDelegate> {
    struct {
...
@property (nonatomic, strong) DGCTYCyclePagerViewLayout *layout;
...
@implementation DGCTYCyclePagerView
...
- (void)addCollectionView {
    DGCTYCyclePagerTransformLayout *layout = [[DGCTYCyclePagerTransformLayout alloc]init];
...
- (DGCTYCyclePagerViewLayout *)layout {
    if (!_layout) {
...
- (void)setDelegate:(id<DGCTYCyclePagerViewDelegate>)delegate {
    _delegate = delegate;
    ...
    if (self.collectionView && self.collectionView.collectionViewLayout) {
        ((DGCTYCyclePagerTransformLayout *)self.collectionView.collectionViewLayout).delegate = _delegateFlags.applyTransformToAttributes ? self : nil;
    }
}

- (void)setDataSource:(id<DGCTYCyclePagerViewDataSource>)dataSource {
...
- (void)updateLayout {
    ...
    ((DGCTYCyclePagerTransformLayout *)_collectionView.collectionViewLayout).layout = self.layout;
}
...
- (void)pagerViewTransformLayout:(DGCTYCyclePagerTransformLayout *)pagerViewTransformLayout initializeTransformAttributes:(UICollectionViewLayoutAttributes *)attributes {
    if (_delegateFlags.initializeTransformAttributes) {
        [_delegate pagerView:self initializeTransformAttributes:attributes];
    }
}

- (void)pagerViewTransformLayout:(DGCTYCyclePagerTransformLayout *)pagerViewTransformLayout applyTransformToAttributes:(UICollectionViewLayoutAttributes *)attributes {
...
- (void)dealloc {
    ((DGCTYCyclePagerTransformLayout *)_collectionView.collectionViewLayout).delegate = nil;
